# Extra Trees Multiclass Classifier in Scikit-Learn with Shapley Explanations
## Project Description
...
- A **Extra Trees Multiclass Classifier** algorithm built using **SciKit-Learn**
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Extra Trees Multiclass Classifier model implemented using **Scikit-Learn** library.
